    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-2 mb-4">
                ...
                @else
                <p class="text-xs text-stone-500 italic">Mod baca-sahaja. Hanya PTRJ atau PRJ boleh mendaftar/mengubah.</p>
                @endif
            </div>
                            ...
                            <tr>
                                <td colspan="5" class="px-4 py-12 text-center">
                                    <div class="flex flex-col items-center gap-3 text-stone-400">
                                        ...
                                        @if($canWrite)<a href="{{ route('no-rujukan.create') }}" class="text-xs text-uitm-purple-700 hover:underline">Daftar No. Rujukan pertama</a>@endif
                                    </div>
                                </td>
                            </tr>
                            @endforelse
